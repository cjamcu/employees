...
void main() {
  ...
  group('validateName', () {
    ...
    test('should return error for name with lowercase letters', () {
      expect(validators.validateName('juan'), equals(l10n.onlyUppercaseLetters));
    });
    ...
    test('should return error for name with invalid characters', () {
      expect(validators.validateName('JUAN123'), equals(l10n.onlyLettersAndSpaces));
    });
  });
  ...
  group('validateOtherNames', () {
    ...
    test('should return error for other names with lowercase letters', () {
      expect(validators.validateOtherNames('jose'), equals(l10n.onlyUppercaseLetters));
    });
    ...
    test('should return error for other names with invalid characters', () {
      expect(validators.validateOtherNames('JOSE123'), equals(l10n.onlyLettersAndSpaces));
    });
  });
